  ...
  initApp = function() {
      ...
      user.getIdToken().then(function(accessToken) {
        ...
        document.getElementById('sign-in').innerHTML = 
        	'<a href="/signout"  onclick="return signout()" class="button-register" data-toggle="modal" data-target="#k-popup-account-register" data-ajax="" data-push-state="false">Đăng xuất</a>';
