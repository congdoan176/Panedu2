var config = {
    apiKey: "AIzaSyDSAoMqgXi5hcQw_fisM6bMN_XwEFxaEis",
    authDomain: "panedu.firebaseapp.com",
    databaseURL: "https://panedu.firebaseio.com",
    projectId: "panedu",
    storageBucket: "panedu.appspot.com",
    messagingSenderId: "204071059794"
  };
...
firebase.auth().setPersistence(firebase.auth.Auth.Persistence.LOCAL);
  ...
  function showLoginUI()
  {
  	...
  	var uiConfig = {
		  ...
		  // Will use popup for IDP Providers sign-in flow instead of the
			// default, redirect.
		  signInFlow: 'popup',
...
ui.start('#firebaseui-auth-container',uiConfig);
  ...
  initApp = function() {
      ...
      user.getIdToken().then(function(accessToken) {
		 ...
		 * emailVerified: emailVerified, phoneNumber: phoneNumber, photoURL:
		 * photoURL, uid: uid, accessToken: accessToken, providerData:
		 * providerData }, null, ' ');
		 */
      });
    } else {
